...
# if __name__ == "__main__":
    # product = Product("orange", 3.7, 10)
    # prod1 = Product("cherry", 5, 25)
    # print(product.title)
    # sh = Shop()
    # sh.add_product(product)
    # sh.add_product(prod1)
    # print(sh.products)
    #
    # print(sh._get_product_index("orange"))
    # print(sh._get_product_index("cherry"))
